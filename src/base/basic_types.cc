...
*/
	...
	const value_t kMinValue[] = { numeric_limits<unsigned char>::min(),
		numeric_limits<char>::min(), numeric_limits<unsigned short>::min(),
		numeric_limits<short>::min(), numeric_limits<unsigned int>::min(),
		numeric_limits<int>::min(), numeric_limits<unsigned long>::min(),
		numeric_limits<long>::min(), numeric_limits<unsigned long long>::min(),
		numeric_limits<long long>::min(), };

	const value_t kMaxValue[] = { numeric_limits<unsigned char>::max(),
		numeric_limits<char>::max(), numeric_limits<unsigned short>::max(),
		numeric_limits<short>::max(), numeric_limits<unsigned int>::max(),
		numeric_limits<int>::max(), numeric_limits<unsigned long>::max(),
